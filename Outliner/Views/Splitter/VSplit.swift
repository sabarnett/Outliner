...
public struct VSplit<P: View, D: SplitDivider, S: View>: View {
    ...
    public func splitter<T>(@ViewBuilder _ splitter: @escaping () -> T) -> VSplit<P, T, S> where T: View {
        return VSplit<P, T, S>(fraction: fraction,
                               hide: hide,
                               constraints: constraints,
                               onDrag: onDrag,
                               primary: {
    ...
    public func constraints(
        ...
        return VSplit(fraction: fraction,
                      hide: hide,
                      constraints: constraints,
                      onDrag: onDrag,
                      primary: {
    ...
    /// Note that `fraction` is different. It is only set when drag ends, and it is used to
    /// determine the initial fraction at open.
